/*
  ...
  - A unique constraint covering the columns `[phone,citizenId]` on the table `User` will be added. If there are existing duplicate values, this will fail.
...
-- CreateIndex
CREATE UNIQUE INDEX "User_phone_citizenId_key" ON "User"("phone", "citizenId");
